...
// ===========================================================================
// Jembatan state datar <-> struct Launch
//
// Ditulis sebagai method di dalam blok `program` karena `impl` untuk tipe
// hasil generate macro belum terverifikasi. Kalau macro mengizinkannya,
// keduanya bisa dipindah keluar tanpa perubahan lain.
// ===========================================================================
